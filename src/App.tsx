...
export const App: React.FC = () => {
  ...
  const { currentView, setCurrentView, navigate, showAdmin, setShowAdmin } =
    useApp();
      ...
      <div className="relative z-10 flex flex-col flex-grow">
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in-up animation-delay-4000">
                <Button
                  ...
                  className="px-8 py-4 text-lg rounded-full shadow-cyan-500/30 hover:shadow-cyan-500/50 transition-all transform hover:-translate-y-1"
                >
                  시작하기
                </Button>
              </div>
        ...
        {currentView === "dashboard" && (
          <div className="relative w-full min-h-screen">
            {!isLoggedIn && (
              <FullPageLockOverlay onLogin={() => setCurrentView("login")} />
            )}

            <div
              className={`w-full pt-36 pb-12 transition-all duration-500 ${!isLoggedIn ? "blur-md opacity-40 select-none pointer-events-none" : ""}`}
            >
                ...
                >
                  ...
                  <div className="flex flex-col gap-8">
                    <div className="w-full">
                      <SpecScore
                        score={
                          userProfile?.isInfoInputted ? dashboardScore.score : 0
                        }
                        percentile={
                          userProfile?.isInfoInputted
                            ? dashboardScore.percentile
                            : 0
                        }
                      ...
                      <div className="bg-white/60 backdrop-blur-sm border border-white/60 rounded-2xl p-6 md:p-8 shadow-sm">
                        <div className="flex justify-between items-center mb-6">
                          ...
                          <button
                            ...
                            onClick={() => setCurrentView("info-management")}
                          >
                            관리하기
                          </button>
                        </div>
                          ...
                          <div className="flex flex-col h-full">
                            ...
                            <div className="space-y-3">
                              {certificates.map((cert, i) => (
                                <div
                                  key={i}
                                  className="flex flex-col sm:flex-row sm:items-center justify-between p-3 rounded-xl bg-white/50 border border-white hover:border-cyan-200 transition-colors"
                                >
                                  <div className="flex items-center gap-3 w-full">
                                    <div
                                      className={`w-1.5 h-10 rounded-full flex-shrink-0 ${cert.type === "lang" ? "bg-indigo-400" : "bg-green-400"}`}
                                    ></div>
                                    <div className="flex-1">
                                      ...
                                      <div className="flex justify-between items-center mt-1">
                                        ...
                                        <span
                                          className={`text-[10px] ${cert.expiry === "영구" ? "text-green-600 font-medium" : "text-gray-400"}`}
                                        >
                                          {cert.expiry === "영구"
                                            ? "영구 유효"
                                            : `${cert.expiry} 만료`}
                            ...
                            <div className="bg-gray-50/50 rounded-xl p-4 border border-gray-100 flex-1">
                              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
                                {skills.map((skill, i) => (
                                  <div
                                    key={i}
                                    className="flex flex-col items-center justify-center p-3 bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all text-center"
                                  >
        ...
        {currentView === "jobs" && (
          <div className="relative w-full">
            ...
            <div
              className={`w-full max-w-7xl mx-auto px-6 pt-36 pb-20 transition-all duration-500 ${!isLoggedIn ? "blur-md opacity-40 select-none pointer-events-none" : ""}`}
            >
              <JobDashboard />
            </div>
          </div>
        ...
        {currentView === "flow-test" && (
          <div className="relative w-full pt-36 pb-20">
            ...
            <div
              className={`${!isLoggedIn ? "blur-md opacity-40 select-none pointer-events-none" : ""}`}
            >
              <SpecFlowTest />
            </div>
          </div>
        ...
        {currentView === "report" && (
          <div className="relative w-full flex-grow">
            ...
            <div
              className={`pt-36 pb-12 transition-all duration-500 ${!isLoggedIn ? "blur-md opacity-40 select-none pointer-events-none" : ""}`}
            >
              <SpecReport
